                ...
                designImg.onload = function() {
                    ...
                    if (photoFile) {
                        ...
                        photoImg.onload = function() {
                            ctx.drawImage(photoImg, 20, 20, 120, 120); // Ajusta la posición y el tamaño de la foto
...
// Manejar la búsqueda de un gafete por Nombre, Apellido e ID
    ...
    fetch(`/BuscarGafete?name=${name}&lastName=${lastName}&id=${id}`)
        ...
        .then(data => {
            ...
            designImg.onload = function() {
                ...
                // Dibujar texto (Nombre y Puesto)
                ctx.font = 'bold 26px Arial';
                ctx.fillStyle = '#000000';
                ctx.fillText(fetchedName, 200, 100);
                ctx.fillText('Puesto: ' + fetchedJob, 140, 60);
            };
            designImg.onerror = function() {
                console.error('No se pudo cargar la imagen de diseño.');
            };
